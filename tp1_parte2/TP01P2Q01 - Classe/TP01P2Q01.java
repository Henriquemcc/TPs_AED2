...
class Presidente
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para transformar uma String contendo data para um objeto do tipo LocalDateTime.
     * @param data String com a data que sera convertida.
     * @return Objeto do tipo LocalDateTime contendo a data da String.
     */
    public LocalDateTime lerData(String data)
    {
        //Dia
        int i=0;
        String dia="";
        while(ehNumero(data.charAt(i)) && i<data.length())
        {
            dia+=data.charAt(i);
            i++;
        }
        ...
        //Mes
        int corteEsquerdo=2+data.indexOf("de");
        int corteDireito=data.lastIndexOf("de");
        String mes=data.substring(corteEsquerdo, corteDireito);

        //Ano
        String ano="";
        i=data.length()-4;
        while(!(ehNumero(data.charAt(i)) && ehNumero(data.charAt(i+1)) && ehNumero(data.charAt(i+2)) && ehNumero(data.charAt(i+3))) && i>=0)
        {
            i--;
        }
        ...
        LocalDateTime objetoData = LocalDateTime.of(somenteNumeros(ano), numeroMes(mes), somenteNumeros(dia), 0, 0);
        return objetoData;

    }//fim do metodo lerData
    ...
    /**
     * Funcao do metodo: Este metodo serve para verificar se esse objeto presidente representa um presidente que esta no cargo.
     * @return Valor booleano indicando se este objeto do tipo Presidente representa um presidente que esta no cargo.
     */
    public boolean estaNoCargo()
    {
        //Data inicio mandato
        int diaInicioMandato=this.getInicioMandato().getDayOfYear();
        int anoInicioMandato=this.getInicioMandato().getYear();

        //Data fim mandato
        int diaFimMandato=this.getFimMandato().getDayOfYear();
        int anoFimMandato=this.getFimMandato().getYear();

        //Data atual
        int diaHoje=LocalDateTime.now().getDayOfYear();
        int anoHoje=LocalDateTime.now().getYear();

        //Verificando se ele ainda esta no cargo
        boolean estaNoCargo=false;
        if(anoHoje<=anoFimMandato && anoHoje>=anoInicioMandato && diaHoje<=diaFimMandato && diaHoje>=diaInicioMandato)
            estaNoCargo=true;

        return estaNoCargo;

    }//fim do metodo estaNoCargo
...
public class TP01P2Q01
{
    ...
    {
        //teste();
        String arquivo[]=new String[1024];
        ...
        while(!arquivo[i++].contains("FIM") && i<1024);
        i=0;
        while(!arquivo[i].contains("FIM") && i<1024)
        {
            
            presidente=new Presidente();
            presidente.lerArquivo(arquivo[i]);
            presidente.imprimir();
            i++;
        }
    }//fim do metodo main
    ...
    /**
     * Funcao do metodo: Este metodo serve para testar se o programa esta funcionando de forma correta com todos os presidentes.
     */
    public static void teste()
    {
        ...
        MyIO.setCharset("UTF-8");
        Presidente presidente;
        String presidentes[]=new String[36];
        presidentes[0]="/tmp/presidente/Afonso_Pena.html";
        presidentes[1]="/tmp/presidente/Artur_Bernardes.html";
        presidentes[2]="/tmp/presidente/Café_Filho.html";
        presidentes[3]="/tmp/presidente/Campos_Sales.html";
        presidentes[4]="/tmp/presidente/Carlos_Luz.html";
        presidentes[5]="/tmp/presidente/Costa_e_Silva.html";
        presidentes[6]="/tmp/presidente/Delfim_Moreira.html";
        presidentes[7]="/tmp/presidente/Deodoro_da_Fonseca.html";
        presidentes[8]="/tmp/presidente/Dilma_Rousseff.html";
        presidentes[9]="/tmp/presidente/Emílio_Garrastazu_Médici.html";
        presidentes[10]="/tmp/presidente/Epitácio_Pessoa.html";
        presidentes[11]="/tmp/presidente/Ernesto_Geisel.html";
        presidentes[12]="/tmp/presidente/Eurico_Gaspar_Dutra.html";
        presidentes[13]="/tmp/presidente/Fernando_Collor_de_Mello.html";
        presidentes[14]="/tmp/presidente/Fernando_Henrique_Cardoso.html";
        presidentes[15]="/tmp/presidente/Floriano_Peixoto.html";
        presidentes[16]="/tmp/presidente/Getúlio_Vargas.html";
        presidentes[17]="/tmp/presidente/Hermes_da_Fonseca.html";
        presidentes[18]="/tmp/presidente/Humberto_de_Alencar_Castelo_Branco.html";
        presidentes[19]="/tmp/presidente/Itamar_Franco.html";
        presidentes[20]="/tmp/presidente/Jair_Bolsonaro.html";
        presidentes[21]="/tmp/presidente/Jânio_Quadros.html";
        presidentes[22]="/tmp/presidente/João_Figueiredo.html";
        presidentes[23]="/tmp/presidente/João_Goulart.html";
        presidentes[24]="/tmp/presidente/José_Linhares.html";
        presidentes[25]="/tmp/presidente/José_Sarney.html";
        presidentes[26]="/tmp/presidente/Juscelino_Kubitschek.html";
        presidentes[27]="/tmp/presidente/Luiz_Inácio_Lula_da_Silva.html";
        presidentes[28]="/tmp/presidente/Michel_Temer.html";
        presidentes[29]="/tmp/presidente/Nereu_Ramos.html";
        presidentes[30]="/tmp/presidente/Nilo_Peçanha.html";
        presidentes[31]="/tmp/presidente/Prudente_de_Moraes.html";
        presidentes[32]="/tmp/presidente/Ranieri_Mazzilli.html";
        presidentes[33]="/tmp/presidente/Rodrigues_Alves.html";
        presidentes[34]="/tmp/presidente/Venceslau_Brás.html";
        presidentes[35]="/tmp/presidente/Washington_Luís.html";
        SecureRandom sr=new SecureRandom();
        int numeroPresidente=sr.nextInt(35);
        presidente=new Presidente();
        presidente.lerArquivo(presidentes[numeroPresidente]);
        presidente.imprimir();

    }//fim do metodo teste
}//fim da classe TP01P2Q01