...
class ListaPresidente
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para ordenar todos os elementos do arranjo presidentes tendo como chave o id de cada presidente e utilizando o SelectionShort.
     */
    public void ordenar()
    {
        long comeco=new Date().getTime();
