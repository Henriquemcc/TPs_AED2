...
class ListaPresidente
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para ordenar todos os elementos do arranjo presidentes tendo como chave a data de nascimento de cada presidente e utilizando o HeapShort.
     */
    public void ordenar()
    {
        long comeco=new Date().getTime();
        ...
        try
        {
            File arquivo=new File("618557_heapsort.txt");
            if (!arquivo.exists())
                arquivo.createNewFile();
