...
class ListaPresidente
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para ordenar todos os elementos do arranjo presidentes tendo como chave o tamanho da pagina de cada presidente e utilizando o InsertionShort.
     */
    public void ordenar()
    {
        long comeco=new Date().getTime();
        ...
        try
        {
            File arquivo=new File("618557_insercao.txt");
            if (!arquivo.exists())
                arquivo.createNewFile();
