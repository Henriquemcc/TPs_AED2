...
class FilaPresidente
{
     ...
     */
    public FilaPresidente(int tamanho)
    {
        presidentes = new Presidente[tamanho+1];
        primeiro=ultimo=0;
    }//fim do construtor
    ...
    public void inserir(String arquivoPresidente) throws Exception
    {
        ...
        inserir(presidente);
        //MyIO.println("TESTE: Inserindo:"+arquivoPresidente);
    ...
    public void inserir(Presidente presidente) throws Exception
    {
        ...
        if(((ultimo+1)%presidentes.length)==primeiro)
            this.remover();

        presidentes[ultimo]=presidente;
        ultimo=(ultimo+1)%presidentes.length;
    }//fim do metodo inserir

    /**
     * Funcao do metodo: Este metodo serve para remover um elemento da primeira posicao registrada do arranjo de objetos do tipo Presidente e retornar o objeto removido ao metodo que o chamou.
    ...
    public Presidente remover() throws Exception
    {
        ...
        Presidente presidente=presidentes[primeiro];
        primeiro=(primeiro+1)%presidentes.length;
        return presidente;
    ...
    public void mostrar()
    {
        ...
        while(i!=ultimo)
        {
            ...
            i=((i+1)%presidentes.length);
        }
    }//fim do metodo mostrar

    /**
     * Funcao do metodo: Este metodo serve para calcular a media das idades dos presidentes contidos na fila circular.
