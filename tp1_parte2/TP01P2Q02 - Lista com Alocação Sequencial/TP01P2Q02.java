...
class ListaPresidente
{
    ...
    /**
     * Funcao do metodo: Este metodo serva para procurar no arranjo de objetos do tipo Presidente por um presidente com um id especifico.
     * @param id Numero ordinario da ordem em que foi presidente.
    ...
    public boolean pesquisar(int id)
    {
        ...
        while(!retorno && i<n)
        {
            retorno=(presidentes[i].getID()==id);
            i++;
        }
        return retorno;
    ...
    public boolean pesquisar(String nomeCompleto)
    {
        ...
        while(!retorno && i<n)
        {
            retorno=(presidentes[i].getNome()==nomeCompleto);
            i++;
        }
        return retorno;
    }//fim do metodo pesquisar
...
class Presidente
{
    ...
    public static String ISO88591toUTF8(String strISO)
    {
        ...
        try
        {
            strUTF8=Utilitarios.ISO88591toUTF8(strISO);
        }
        catch(Exception e)
        {
            System.out.println(e);
    ...
    public static String UTF8toISO88591(String strUTF8)
    {
        ...
        try
        {
            strISO88591=Utilitarios.UTF8toISO88591(strUTF8);
        }
        catch(Exception e)
        {
            System.out.println(e);
...
class Utilitarios
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para converter uma String em ISO8859 para UTF8.
     * @param strISO String em ISO8859 que sera convertida para UTF8.
     * @return String convertida para UTF8.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para converter uma String em UTF8 para ISO88591.
     * @param strUTF8 String em UTF8 que sera convertida para ISO88591.
     * @return String convertida para ISO88591.
     */
    public static String UTF8toISO88591(String strUTF8) throws Exception
    {
