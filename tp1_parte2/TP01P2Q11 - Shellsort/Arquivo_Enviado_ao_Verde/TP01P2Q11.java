...
class ListaPresidente
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para encontrar qual das duas posic�es (passadas por parametro) do arranjo Presidentes � a cujo presidente possua o menor ID.
