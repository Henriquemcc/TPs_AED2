...
class Hash
{
     ...
     * @param m1 Tamanho da tabela hash (normal).
     * @param m2 Tamanho da area de reserva da tabela.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para gerar a hash do id do presidente.
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente na tabela hash.
     * @param elemento Objeto do tipo Presidente que sera inserido na tabela hash.
     * @throws Exception Caso nao seja possivel inserir, uma excecao sera gerada.
     */
    public void inserir(Presidente elemento) throws Exception
    {
        if(elemento==null)
        {
            throw new Exception("Erro ao inserir! O elemento eh nulo.");
        }
        ...
        else if(this.m1+this.reserva<this.m)
        {
            this.tabela[this.m1+this.reserva]=elemento;
            this.reserva++;
        }
        else
        {
    ...
    /**
     * Funcao do metodo: Este metodo serve para pesquisar por um objeto do tipo Presidente, utilizando como chave de pesquisa o nome.
     * @param nome Chave de pesquisa (nome) do objeto do tipo Presidente que esta sendo procurado.
    ...
    public boolean pesquisar(String nome)
    {
        ...
        try
        {
            File arquivo=new File("618557_hashReserva.txt");
            if(!arquivo.exists())
            {
        ...
        {
            if(this.tabela[i]!=null && this.tabela[i].getNome().equals(nome))
            {
                resp=true;
                i=this.m1;
            }
    ...
    /**
     * Funcao do metodo: Este metodo serve para imprimir todos os objetos do tipo Presidente presentes na tabela hash.
     * Ele so sera utilizado para debugar o programa.
     */
    public void imprimir()
    {
        MyIO.println("\nImprimindo tabela:");
