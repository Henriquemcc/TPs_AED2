...
class No
{
     ...
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo No.
     * @param elemento Objeto do tipo Presidente que sera adicionado ao no.
     * @param esq Referencia apontando para o no a esquerda.
     * @param dir Referencia apontando para o no a direita.
     * @param nivel Numero inteiro referente ao nivel do no.
     */
    public No(Presidente elemento, No esq, No dir, int nivel)
    {
    ...
    /**
     * Funcao do metodo: Este metodo serve para atualizar o valor da variavel nivel do no.
     * @return No com o seu nivel alterado.
     */
    public No setNivel()
    {
        this.nivel=1+Math.max(getNivel(esq), getNivel(dir));
        return this;
    }//fim do metodo setNivel

    /**
     * Funcao do metodo: Este metodo serve para obter o valor do nivel do no.
     * @param no No o qual sera obtido o nivel.
     * @return Numero inteiro indicando o nivel do no.
     */
    public static int getNivel(No no)
    {
        return (no==null) ? 0 : no.nivel;
    }//fim do metodo getNivel
...
class AVL
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo AVL.
     */
    public AVL()
    {
        raiz=null;
    }//fim do metodo construtor AVL

    /**
     * Funcao do metodo: Este metodo serve para obter a altura da AVL.
     * @return Numero inteiro indicando a altura da arvore.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para realizar a pesquisa na AVL.
    ...
    public boolean pesquisar(String nome)
    {
        ...
        try
        {
            File arquivo=new File("618557_avl.txt");
            if(!arquivo.exists())
            {
        ...
        boolean resp=pesquisar(raiz, nome, 0);
    ...
    /**
     * Funcao do metodo: Este metodo serve para realizar a pesquisa na AVL.
     * @param no No o qual sua subarvore sera realizada a pesquisa.
     * @param chave Chave de pesquisa.
     * @param qtdComparacoes Quantidade de comparacoes que foram realizadas anteriormente.
     * @return Valor booleano indicando se o presidente foi encontrado.
     */
    private boolean pesquisar(No no, String chave, int qtdComparacoes)
    {
        boolean resp;
        if(no==null)
        {
        ...
        else if(chave.equals(no.elemento.getNome()))
        {
            resp=true;
            qtdComparacoes+=2;
            try
        ...
        else if(chave.compareTo(no.elemento.getNome())<0)
        {
            MyIO.print("esq ");
            qtdComparacoes+=3;
            resp=pesquisar(no.esq, chave, qtdComparacoes);
        ...
        else
        {
            MyIO.print("dir ");
            qtdComparacoes+=3;
            resp=pesquisar(no.dir, chave, qtdComparacoes);
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um novo objeto do tipo Presidente a AVL.
     * @param x Objeto do tipo Presidente que sera inserido na AVL.
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um novo objeto do tipo Presidente a AVL.
     * @param no No cabeca para a arvore/subarvore a qual o presidente sera inserido.
     * @param x Objeto do tipo Presidente que sera inserido na AVL.
     * @return No cabeca para a arvore/subarvore resultante da insercao.
     * @throws Exception Caso nao seja possivel inserir uma nova excecao sera gerada.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente por meio da leitura de um arquivo HTML do presidente.
     * @param arquivoPresidente Arquivo HTML com as informacoes do presidente que sera inserido na AVL.
     * @throws Exception Caso nao seja possivel inserir uma nova excecao sera gerada.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para balancear uma AVL.
     * @param no No cabeca da arvore/subarvore que sera rotacionado.
     * @return No cabeca da nova arvore/subarvore balanceada.
     * @throws Exception Caso ocorra erro de balanceamento uma nova excecao sera gerada.
     */
    private No balancear(No no) throws Exception
    {
        if(no!=null)
        {
            ...
            //Se desbalancear para a esquerda
            else if(fator==-2)
            {
            ...
            {
                throw new Exception("Erro de balanceamento ("+fator+") invalido!");
            }
        }
        return no;
    }//fim da funcao balancear

    /**
     * Funcao do metodo: Este metodo serve para rotacionar a direita o no avo da AVL.
     * @param no No avo que sera rotacionado.
     * @return No cabeca da nova arvore/subarvore resultante da rotacao.
     */
    private No rotacionarDir(No no)
    {
        ...
        return noEsq;
    }//fim do metodo rotacionarDir

    /**
     * Funcao do metodo: Este metodo serve para rotacionar a esquerda o no avo da AVL.
     * @param no No avo que sera rotacionado.
     * @return No cabeca da nova arvore/subarvore resultante da rotacao.
     */
