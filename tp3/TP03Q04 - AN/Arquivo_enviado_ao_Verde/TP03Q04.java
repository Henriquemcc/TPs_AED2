...
class No
{
     ...
     * @param elemento Referencia para o objeto do tipo Presidente, que sera adicionada ao no.
     * @param cor Valor booleano indicando a cor do no.
     * @param esq Referencia para o no filho esquerdo.
     * @param dir Referencia para o no filho direito.
     */
...
class Alvinegra
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo Alvinegra.
     */
    public Alvinegra()
    {
        raiz=null;
    }//fim do metodo construtor Alvinegra

    //Metodos

    /**
     * Funcao do metodo: Este metodo serve para pesquisar um elemento do tipo Presidente da arvore.
     * @param elemento Chave de pesquisa (nome do Presidente) que sera procurado.
     * @param i Referencia para o no da arvore/subarvore o qual a partir dele sera caminhado na arvore.
     * @param qtdComparacoes Numero de comparacoes que foram anteriormente realizadas para que seja realizada a soma que sera salva no arquivo.
     * @return Valor booleano indicando se o Presidente com a chave de pesquisa (nome) procurada foi encontrado.
     */
    private boolean pesquisar(String elemento, No i, int qtdComparacoes)
    {
        boolean resp;
        if(i==null)
        {
            ...
            try
            {
                File arquivo=new File("618557_avinegra.txt");
        ...
        else if(elemento.compareTo(i.elemento.getNome())<0)
        {
            MyIO.print("esq ");
            qtdComparacoes+=3;
            resp=pesquisar(elemento, i.esq, qtdComparacoes);
        }
        else
        {
            MyIO.print("dir ");
            qtdComparacoes+=3;
            resp=pesquisar(elemento, i.dir, qtdComparacoes);
        }
        return resp;
     ...
     * Funcao do metodo: Este metodo serve para pesquisar um elemento do tipo Presidente da arvore.
     * @param elemento Chave de pesquisa (nome do Presidente) que sera procurado.
     * @return Valor booleano indicando se o Presidente com a chave de pesquisa (nome) procurada foi encontrada.
     */
    public boolean pesquisar(String elemento)
    {
        ...
        boolean resp=pesquisar(elemento, this.raiz, 0);
    ...
    /**
     * Funcao do metodo: Este metodo serve para rotacionar a direita a arvore/subarvore passada por parametro.
     * @param no Referencia para o no cabeca da arvore/subarvore a ser rotacionada.
     * @return Referencia para o no cabeca da arvore/subarvore resultante da rotacao.
     */
    private No rotacaoDir(No no)
    {
        ...
        return noEsq;
    }//fim do metodo rotacaoDir

    /**
     * Funcao do metodo: Este metodo serve para rotacionar a esquerda a arvore/subarvore passada por parametro.
     * @param no Referencia para o no cabeca da arvore/subarvore a ser rotacionada.
     * @return Referencia para o no cabeca da arvore/subarvore resultante da rotacao.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para rotacionar a direita o filho a direita da a arvore/subarvore passada por parametro para depois rotacionar a arvore para a esquerda.
     * @param no Referencia para o no cabeca da arvore/subarvore a ser rotacionada.
     * @return Referencia para o no cabeca da arvore/subarvore resultante da rotacao.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para rotacionar a esquerda o filho a esquerda da a arvore/subarvore passada por parametro para depois rotacionar a arvore para a direita.
     * @param no Referencia para o no cabeca da arvore/subarvore a ser rotacionada.
     * @return Referencia para o no cabeca da arvore/subarvore resultante da rotacao.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para balancear a arvore passada por parametro, sabendo os nos i pai avo e bisavo.
     * @param bisavo Referencia ao objeto do tipo No bisavo de i.
     * @param avo Referencia ao objeto do tipo No avo de i.
     * @param pai Referancia ao objeto do tipo No pai de i.
     * @param i Referencia ao objeto do tipo No i.
     */
    private void balancear(No bisavo, No avo, No pai, No i)
    {
        //Se o pai tambem e preto, reequilibrar a arvore, rotacioanando o avo
        if(pai.cor)
        {
            //4 tipos de reequilibros e acoplamento
            ...
            //Rotacao a direita ou a esquerda-direita
            else
            {
                if(i.elemento.getNome().compareTo(pai.elemento.getNome())<0)
                {
    ...
    }//fim do metodo balancear

    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente na arvore por meio da leitura de um arquivo HTML.
     * @param arquivoPresidente Arquivo HTML referente a um presidente que sera lido, gerando um objeto do tipo Presidente que sera inserido na arvore.
     * @throws Exception Caso nao seja possivel inserir uma excecao sera gerada.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a arvore.
     * @param elemento Referencia para o objeto do tipo Presidente que sera inserido na arvore.
     * @param bisavo Referencia para o objeto do tipo No bisavo de i.
     * @param avo Referencia para o objeto do tipo No avo de i.
     * @param pai Referencia para o objeto do tipo No pai de i.
     * @param i Referencia para o objeto do tipo No i.
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a arvore.
     * @param elemento Referencia para um objeto do tipo Presidente que sera inserido na arvore.
     * @throws Exception Caso nao seja possivel inserir, uma nova excecao sera gerada.
     */
