...
class Celula
{
     ...
     * @param elemento Objeto do tipo Presidente que sera colocado na Celula.
     * @param prox Referencia para o proximo objeto do tipo Celula.
     */
    public Celula(Presidente elemento, Celula prox)
    {
...
class Lista
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo Lista
     */
    public Lista()
    {
        primeiro=new Celula();
        ultimo=primeiro;
    }//fim do metodo construtor Lista


    /**
     * Funcao do metodo: Este metodo serve para pesquisar por um objeto do tipo Presidente na lista.
     * @param nome Chave de pesquisa (nome).
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente no inicio da lista.
     * @param elemento Objeto do tipo Presidente que sera inserido na lista.
     */
    public void inserirInicio(Presidente elemento)
    {
...
class Hash
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo Hash
    ...
    /**
     * Funcao do metodo: Este metodo serve para gerar uma nova hash do id do Presidente.
     * @param id id do Presidente.
     * @return Hash do id do Presidente.
     */
    public int h(int id)
    {
        return id%tamanho;
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente na tabela hash no inicio da lista auxiliar.
     * @param elemento Objeto do tipo Presidente que sera adicionado a tabela hash.
     * @throws Exception Caso nao seja possivel inserir, uma nova excecao sera gerada.
     */
    public void inserirInicio(Presidente elemento) throws Exception
    {
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente na tabela hash, por meio da leitura do arquivo HTML.
     * @param arquivoPresidente Arquivo HTML do Presidente.
    ...
    /**
     * Funcao do metodo: Este metodo serve para pesquisar por um novo objeto do tipo Presidente.
     * @param nome Chave de pesquisa (nome) do objeto do tipo Presidente.
     * @return Valor booleano indicando se o objeto foi encontrado.
     */
    public boolean pesquisar(String nome)
    {
        ...
        try
        {
            File arquivo=new File("618557_hashIndireta.txt");
            if(!arquivo.exists())
            {
