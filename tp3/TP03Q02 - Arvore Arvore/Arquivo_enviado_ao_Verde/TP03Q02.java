...
class No2
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo No2.
    ...
    }//fim do metodo construtor No2
    
    /**
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo No2.
     * @param elemento Objeto do tipo Presidente que sera adicionado ao no.
     * @param esq Referencia para o No a esquerda.
     * @param dir Referencia para o No a direita.
     */
...
class No
{
     ...
     * @param dir Referencia para o No a direita.
     */
    public No(int idade, No esq, No dir)
    {
		this.idade = idade;
		this.esq = esq;
		this.dir = dir;
...
class ArvoreArvore
{
    ...
    //-------METODOS CONSTRUTORES--------//
    /**
     * Funcao do metodo: Este metodo serve para construir uma nova arvore com nos do tipo No.
     * @param idade Chave da arvore binaria.
     * @param i No o qual a partir dele sera construida a arvore.
     * @return No referente ao pedaco da arvore construida.
     */
    private No construir(int idade, No i)
    {
        if(i==null)
        {
            i=new No(idade);
        }
        else if(idade<i.idade)
        {
            i.esq=construir(idade, i.esq);
        }
        else if(idade>i.idade)
        {
            i.dir=construir(idade, i.dir);
        }
        return i;
     ...
     * @param idade Chave da arvore binaria.
     */
    private void construir(int idade)
    {
        raiz=construir(idade, raiz);
    }//fim do metodo construir

    /**
     * Funcao da funcao: Esta funcao serve para construir um novo objeto do tipo ArvoreArvore.
     */
    public ArvoreArvore()
    {
	    raiz = null;
        ...
        construir(13);
        construir(14);
    }//fim do metodo construtor ArvoreArvore

    //-------METODOS DE MANIPULACAO DE ARVORE-------//

    //Inserir
    /**
     * Funcao do metodo: Este metodo serve para inserir objetos do tipo Presidente na segunda arvore.
     * @param presidente Objeto do tipo Presidente que sera inserido na segunda arvore.
     * @param i No o qual a partir dele ocorrera a insercao.
     * @return No referente ao pedaco de arvore que foi inserido.
     */
    private No2 inserirSegundaArvore(Presidente presidente, No2 i)
    {
        if(i==null)
        {
            i=new No2(presidente);
        }
        else if(presidente.getIdade()<i.elemento.getIdade())
        {
            i.esq=inserirSegundaArvore(presidente, i.esq);
        }
        else if(presidente.getIdade()>i.elemento.getIdade())
        {
            i.dir=inserirSegundaArvore(presidente, i.dir);
        }
        return i;        
    }//fim da funcao inserirSegundaArvore

    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a uma arvore de arvore.
     * @param presidente Objeto do tipo Presidente que sera inserido na arvore de arvore.
     * @param i No o qual a partir dele ocorrera a insercao.
     */
    private void inserir(Presidente presidente, No i)
    {
        if(presidente.getIdade()%15==i.idade)
        {
            i.outro=inserirSegundaArvore(presidente, i.outro);
        }
        else if(presidente.getIdade()%15<i.idade && i.esq!=null)
        {
            inserir(presidente, i.esq);
        }
        else if(presidente.getIdade()%15>i.idade && i.dir!=null)
        {
            inserir(presidente, i.dir);
        }
    }//fim da funcao inserir
    
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a arvore de arvore.
     * @param presidente Objeto do tipo Presidente que sera inserido na arvore de arvore.
     */
    public void inserir(Presidente presidente)
    {
        inserir(presidente, raiz);
    }//fim da funcao inserir

    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a arvore de arvore a partir da leitura de um arquivo HTML de um presidente.
     * @param arquivoPresidente Localizacao do arquivo HTML do presidente que sera lido e inserido na arvore.
     */
    public void inserir(String arquivoPresidente)
    {
    ...
    //Pesquisar
    /**
     * Funcao do metodo: Este metodo serve para pesquisar um elemento da segunda arvore, tendo como chave de pesquisa o nome do presidente.
     * @param nome Nome do presidente que sera usado como chave de pesquisa.
     * @param i No o qual a partir dele ocorrera a pesquisa.
     * @param qtdComparacoes Numero de comparacoes o qual sera, durante a operacao somado e escrito no arquivo.
     * @return Valor booleano indicando se o presidente procurado foi encontrado.
     */
    private boolean pesquisarSegundaArvore(String nome, No2 i, int qtdComparacoes)
    {
        boolean resp=false;
        if(i!=null)
        {
            ...
            if(i.elemento.getNome().equals(nome))
            {
                ...
                try
                {
                    File arquivo=new File("618557_arvoreArvore.txt");
            ...
            if(!resp)
            {
                qtdComparacoes+=2;
                MyIO.print("ESQ ");
                resp=pesquisarSegundaArvore(nome, i.esq, qtdComparacoes);
            }
            ...
            if(!resp)
            {
                qtdComparacoes+=3;
                MyIO.print("DIR ");
                resp=pesquisarSegundaArvore(nome, i.dir, qtdComparacoes);    
            }
            
        }
        return resp;
    }//fim da funcao pesquisarSegundaArvore

    /**
     * Funcao do metodo: Este metodo serve para pesquisar um elemento da primeira arvore, tendo como chave de pesquisa o nome do presidente.
     * @param nome Nome do presidente que sera usado como chave de pesquisa.
     * @param i No o qual a partir dele ocorrera a pesquisa.
     * @param qtdComparacoes Numero de comparacoes o qual sera, durante a operacao somado e escrito no arquivo.
     * @return Valor booleano indicando se o presidente procurado foi encontrado.
    ...
    private boolean pesquisar(String nome, No i, int qtdComparacoes)
    {
        ...
        {
            qtdComparacoes+=1;
            resp=pesquisarSegundaArvore(nome, i.outro, qtdComparacoes);            
        ...
        return resp;
    }//fim da funcao pesquisar

    /**
     * Funcao do metodo: Este metodo serve para pesquisar um elemento da arvore de arvore, tendo como chave de pesquisa o nome do presidente.
     * @param nome Nome do presidente que sera usado como chave de pesquisa.
     * @return Valor booleano indicando se o presidente procurado foi encontrado.
     */
    public boolean pesquisar(String nome)
    {
        ...
        //Imprimendo o tempo de pesquisa no arquivo
        try
        {
            File arquivo=new File("618557_arvoreArvore.txt");
            FileWriter fw=new FileWriter(arquivo, true);
