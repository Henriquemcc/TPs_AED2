...
class Hash
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para gerar a rehash do id do presidente.
     * @param id id do presidente.
     * @return Rehash do id do presidente.
     */
    public int reh(int id)
    {
        return ++id%m;
    }//fim do metodo reh
    ...
    public void inserir(Presidente elemento) throws Exception
    {
        ...
        else
        {
            ...
            {
                throw new Exception("Erro ao inserir! A tabela e a area de reserva estao cheias.");
            }
        }
    ...
    public boolean pesquisar(String nome)
    {
        ...
        try
        {
            File arquivo=new File("618557_hashRehash.txt");
            if(!arquivo.exists())
            {
