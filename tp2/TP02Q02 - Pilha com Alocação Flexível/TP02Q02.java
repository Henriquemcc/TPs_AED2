...
class PilhaPresidente
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para obter a quantidade de elementos da pilha.
     * @return Numero inteiro indicando a quantidade de elementos da pilha.
     */
    public int quantidadeElementos()
    {
        ...
        return j;
    }//fim do metodo quantidadeElementos
    
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente na pilha com alocacao flexivel de presidentes, passando a localizacao do arquivo que esse objeto sera lido.
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a pilha com alocacao flexivel de presidentes.
     * @param presidente Objeto do tipo Presidente que sera adicionado a pilha de alocacao flexivel de presidentes.
     * @throws Exception Caso qualquer excecao ocorrer, o metodo que o chamou devera trata-la.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para remover um objeto do tipo Presidente da pilha com alocacao flexivel de presidentes.
     * @return Objeto do tipo Presidente que foi removido da pilha de alocacao flexivel.
     * @throws Exception Caso qualquer excecao ocorrer, o metodo que o chamou devera trata-la.
     */
    public Presidente remover() throws Exception
    {
        ...
        Presidente resp=topo.presidente;
        Celula tmp=topo;
        topo=topo.proximo;
        tmp.proximo=null;
        tmp=null;
    ...
    public void mostrar()
    {
        ...
        for(int i=0;i<=n;i++)
        {
            Celula j=this.topo;
            int k=0;
            while(k<n-i-1 && j!=null && j.proximo!=null)
            {
                j=j.proximo;
                k++;
            }
            ...
            {
                MyIO.print("["+i+"] ");
                j.presidente.imprimir();
            }
            
        }                
    }//fim do metodo mostrar

}//fim da classe PilhaPresidente
...
public class TP02Q02
{
    ...
    public static void main(String[]args)
    {
        ...
        PilhaPresidente pilha = new PilhaPresidente();
        ...
        for(i=0;i<qtdOperacoes;i++)
        {
            ...
            else if(operacoes[i].charAt(0)=='R')
            {
                ...
                try
                {
                    presidenteRemovido=pilha.remover();
                }
                catch(Exception e)
                {
                    System.out.println(e);
