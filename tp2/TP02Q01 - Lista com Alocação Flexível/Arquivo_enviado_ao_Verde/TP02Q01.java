...
class Celula
{
    ...
    //Construtores
    /**
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo Celula sem passar nenhum parametro.
     */
    public Celula() 
    {
	...
	/**
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo Celula passando como parametro o objeto Presidente.
     * @param presidente Objeto do tipo Presidente que sera adicionado a celula.
     */
    public Celula(Presidente presidente) 
    {
    ...
    /**
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo Celula passando como parametro o Objeto Presidente e o ponteiro da proxima celula.
     * @param presidente Objeto do tipo Presidente que sera adicionado a celula.
     * @param proximo Ponteiro apontando para a proxima celula.
     */
    public Celula(Presidente presidente, Celula proximo)
    {
        this.presidente=presidente;
...
class ListaPresidente
{
    ...
    /**
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo ListaPresidente sem passar nenhum parametro.
     */
    public ListaPresidente()
    {
        primeiro=new Celula();
        ultimo=primeiro;
    }//fim do metodo construtor ListaPresidente

    //Metodos

    /**
     * Funcao do metodo: Este metodo serve para obter o tamanho da lista.
     * @return Numero inteiro indicando o tamanho, em numero de elementos, da lista.
     */
    public int tamanho()
    {
        int tamanho=0;
        for(Celula i=primeiro;i!=ultimo;i=i.proximo)
        {
            tamanho++;
        }
        return tamanho;
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a posicao inicial da lista com alocacao flexivel de presidentes.
     * @param x Objeto do tipo Presidente que sera adicionado a lista de alocacao flexivel.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a posicao inicial da lista com alocacao flexivel de presidentes, passando a localizacao do arquivo que esse objeto sera lido.
     * @param arquivoPresidente Localizacao do arquivo HTML que contem as informacoes que o objeto do tipo Presidente devera ler.
     * @throws Exception Caso qualquer excecao ocorrer, o metodo que o chamou devera trata-la.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a posicao final da lista com alocacao flexivel de presidentes.
     * @param x Objeto do tipo Presidente que sera adicionado a lista de alocacao flexivel de presidentes.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a posicao final da lista com alocacao flexivel de presidentes, passando a localizacao do arquivo que esse objeto sera lido.
     * @param arquivoPresidente Localizacao do arquivo HTML que contem as informacoes que o objeto do tipo Presidente devera ler.
     * @throws Exception Caso qualquer excecao ocorrer, o metodo que o chamou devera trata-la.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a uma posicao específica da lista com alocacao flexivel de presidentes.
     * @param x Objeto do tipo Presidente que sera adicionado a lista de alocacao flexivel de presidentes.
     * @param posicao Posicao de lista de alocacao felxivel que o objeto sera adicionado.
     * @throws Exception Caso qualquer excecao ocorrer, o metodo que o chamou devera trata-la.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a uma posicao específica da lista com alocacao flexivel de presidentes, passando a localizacao do arquivo que esse objeto sera lido.
     * @param arquivoPresidente Localizacao do arquivo HTML que contem as informacoes que o objeto do tipo Presidente devera ler.
     * @param posicao Posicao de lista de alocacao felxivel que o objeto sera adicionado.
     * @throws Exception Caso qualquer excecao ocorrer, o metodo que o chamou devera trata-la.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para remover um objeto do tipo Presidente da posicao inicial da lista com alocacao flexivel de presidentes.
     * @return Objeto do tipo Presidente que foi removido da lista de alocacao flexivel.
     * @throws Exception Caso qualquer excecao ocorrer, o metodo que o chamou devera trata-la.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para remover um objeto do tipo Presidente da posicao final da lista com alocacao flexivel de presidentes.
     * @return Objeto do tipo Presidente que foi removido da lista de alocacao flexivel.
     * @throws Exception Caso qualquer excecao ocorrer, o metodo que o chamou devera trata-la.
     */
    public Presidente removerFim() throws Exception
    {
        ...
        ultimo=i;
        i=ultimo.proximo=null;

        return resp;
    }//fim do metodo removerFim

    /**
     * Funcao do metodo: Este metodo serve para remover um objeto do tipo Presidente de uma posicao especifica da lista com alocacao flexivel de presidentes.
     * @param posicao Posicao que o objeto do tipo Presidente sera removido da lista de alocacao flexivel.
     * @return Objeto do tipo Presidente que foi removido da lista de alocacao flexivel.
     * @throws Exception Caso qualquer excecao ocorrer, o metodo que o chamou devera trata-la.
     */
    ...
    /**
     * Funcao do metodo: Este metodo serve para mostrar (na saida padrao) todos os elementos da lista de alocacao flexivel de objetos do tipo Presidente.
     */
    public void mostrar()
    {
...
public class TP02Q01
{
    ...
    public static void main(String[]args)
    {
        ...
        while(!arquivo[i++].contains("FIM") && i<100);
        ...
        String operacoes[]=new String[qtdOperacoes];
        //  Lendo as operacoes
        ...
        for(i=0;i<qtdOperacoes;i++)
        {
            ...
            if(operacoes[i].charAt(0)=='I')
            {
                //Inicio
                if(operacoes[i].charAt(1)=='I')
                {
                    String arquivoInsercao=operacoes[i].substring(3, operacoes[i].length());
                    try
                    {
                        lista.inserirInicio(arquivoInsercao);
                    }
                    catch(Exception e)
                    {
                        System.out.println(e);
                ...
                //Fim
                else if(operacoes[i].charAt(1)=='F')
                {
                    String arquivoInsercao=operacoes[i].substring(3, operacoes[i].length());
                    try
                    {
                        lista.inserirFim(arquivoInsercao);
                    }
                    catch(Exception e)
                    {
                        System.out.println(e);
                ...
                //Posicao especifica
                else if(operacoes[i].charAt(1)=='*')
                {
                    //Procurando e lendo a posicao
                    int j=2;
                    while(!ehNumero(operacoes[i].charAt(j)) && j<operacoes[i].length())
                        j++;
                    int esquerda=j;
                    while(ehNumero(operacoes[i].charAt(j)) && j<operacoes[i].length())
                        j++;
                    int direita=j;
                    int posicao=Integer.parseInt(operacoes[i].substring(esquerda, direita));

                    //Procurando e lendo o local do arquivo do presidente
                    esquerda=j+1;
                    String arquivoInsercao=operacoes[i].substring(esquerda, operacoes[i].length());

                    //Inserindo o presidente
                    try
                    {
                        lista.inserir(arquivoInsercao, posicao);
                    }
                    catch(Exception e)
                    {
                        System.out.println(e);
            ...
            else if(operacoes[i].charAt(0)=='R')
            {
                Presidente presidenteRemovido=new Presidente();
                //Inicio
                if(operacoes[i].charAt(1)=='I')
                {
                    try
                    {
                        presidenteRemovido=lista.removerInicio();
                    }
                    catch(Exception e)
                    {
                        System.out.println(e);
                ...
                else if(operacoes[i].charAt(1)=='F')
                {
                    try
                    {
                        presidenteRemovido=lista.removerFim();
                    }
                    catch(Exception e)
                    {
                        System.out.println(e);
                ...
                {
                    //Procurando e lendo a posicao
                    int posicao=Integer.parseInt(operacoes[i].substring(3, operacoes[i].length()));
                    try
                    {
                        presidenteRemovido=lista.remover(posicao);
                    }
                    catch(Exception e)
                    {
                        System.out.println(e);
                ...
                MyIO.setCharset("ISO-8859-1");
                MyIO.print("(R) "+presidenteRemovido.getNome()+"\n");
            }
        }


        //Exibindo os presidentes
        lista.mostrar();
    }//fim do metodo main
    
}//fim da classe TP02Q01