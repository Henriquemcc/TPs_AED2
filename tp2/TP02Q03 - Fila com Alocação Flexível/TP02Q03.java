...
class FilaPresidente
{
    //Atributos
    private Celula primeiro;
    private Celula ultimo;
    private int tamanhoMaximo=5;

    
    //Construtor
    /**
     * Funcao do metodo: Este metodo serve para construir um novo objeto do tipo FilaPresidente.
     */
    public FilaPresidente()
    {
        primeiro=new Celula();
        ultimo=primeiro;
    }//fim do metodo construtor FilaPresidente

    
    //Metodos

    /**
     * Funcao do metodo: Este metodo serve para obter o tamanho da fila.
     * @return Numero inteiro indicando o tamanho, em numero de elementos, da fila.
     */
    public int tamanho()
    {
        int tamanho=0;
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a fila com alocacao flexivel de presidentes, fazendo a leitura do arquivo HTML do presidente.
     * @param arquivoPresidente Localizacao do arquivo HTML do presidente que sera lido.
    ...
    /**
     * Funcao do metodo: Este metodo serve para inserir um objeto do tipo Presidente a fila com alocacao flexivel de presidentes.
     * @param x Objeto do tipo Presidente que sera adicionado a fila de alocacao flexivel de presidentes.
     * @throws Exception Caso qualquer excecao ocorrer, o metodo que o chamou devera trata-la.
     */
    public void inserir(Presidente x) throws Exception
    {
        ...
        {
            throw new Exception("Erro: Nao foi possivel inserir: A fila esta cheia");
        }
    ...
    /**
     * Funcao do metodo: Este metodo serve para remover um objeto do tipo Presidente da fila com alocacao flexivel de presidentes.
    ...
    public Presidente remover() throws Exception
    {
        if(primeiro==ultimo)
        {
            throw new Exception("Erro ao remover: Nao ha nada para remover!");
        }
    ...
    /**
     * Funcao do metodo: Este metodo serve para imprimir na (saida parao) os dados dos presidentes da fila de alocacao flexivel. 
     */
    public void mostrar()
    {
    ...
    /**
     * Funcao do metodo: Este metodo serve para calcular a media das idades dos presidentes contidos na fila de alocacao flexivel.
     * @return Valor inteiro contendo a media das idades dos presidentes.
     */
    public int getMediaIdadePresidentes()
    {
        double media=0;
        Celula i=primeiro.proximo;
        int j=0;
        ...
        return (int) media;
    }//fim do metodo getMediaIdadePresidentes

}//fim da classe FilaPresidente
...
public class TP02Q03
{
    ...
    public static void main(String[]args)
    {
        ...
        FilaPresidente fila = new FilaPresidente();
        ...
        while(!arquivo[i].contains("FIM") && i<100)
        {
            ...
            MyIO.println(fila.getMediaIdadePresidentes());
            i++;
        }
        ...
        for(i=0;i<qtdOperacoes;i++)
        {
            ...
            {
                String arquivoInsercao=operacoes[i].substring(2, operacoes[i].length());
                boolean excecao=false;
                do
                {
                    try
                    {
                        fila.inserir(arquivoInsercao);
                        excecao=false;
            ...
            else if(operacoes[i].charAt(0)=='R')
            {
                ...
                try
                {
                    presidenteRemovido=fila.remover();
                }
                catch(Exception e)
                {
                    System.out.println(e);
